    ...
    public static class ShopScreenPatches {
        ...
        public static class ShopScreenInit {
            ...
            public static void PostShopInitializeHook() {
                ShopGridInitializer.publishPostShopInitialize();
            }
        }
        ...
        public static class InitRelics {
            ...
            public static void InitializeGrid() {
                ShopGrid.initialize();
                ShopGridInitializer.publishPostGridInitialize();
            }
                ...
                return new ExprEditor() {
                    public void edit(MethodCall m) throws CannotCompileException {
                        if (m.getMethodName().equals("draw")) {
                            m.replace(""
                                + "{"
                                    + "if (shopgrid.patches.ShopGridPatch.StoreRelicPatches.Render.canRenderGold(this))"
                                        + "sb.draw($1, $2, shopgrid.patches.ShopGridPatch.StoreRelicPatches.Render.goldY(this, RELIC_GOLD_OFFSET_Y), $4, $5);"
                                + "}"
                            );
                        }
                    }
                ...
                return new ExprEditor() {
                    public void edit(MethodCall m) throws CannotCompileException {
                        if (m.getMethodName().equals("renderFontLeftTopAligned")) {
                            m.replace(""
                                + "{"
                                    + "if (shopgrid.patches.ShopGridPatch.StoreRelicPatches.Render.canRenderText($1, this))"
                                        + "com.megacrit.cardcrawl.helpers.FontHelper.renderFontLeftTopAligned($1, $2, $3, "
                                        + "shopgrid.patches.ShopGridPatch.StoreRelicPatches.Render.textX(this, RELIC_PRICE_OFFSET_X), "
                                        + "shopgrid.patches.ShopGridPatch.StoreRelicPatches.Render.textY(this, RELIC_PRICE_OFFSET_Y), $6);"
                                + "}"
                            );
                        }
                    }
                ...
                return new ExprEditor() {
                    public void edit(MethodCall m) throws CannotCompileException {
                        if (m.getMethodName().equals("draw")) {
                            m.replace(""
                                + "{"
                                    + "if (shopgrid.patches.ShopGridPatch.StorePotionPatches.Render.canRenderGold(this))"
                                        + "sb.draw($1, $2, shopgrid.patches.ShopGridPatch.StorePotionPatches.Render.goldY(this, RELIC_GOLD_OFFSET_Y), $4, $5);"
                                + "}"
                            );
                        }
                    }
                ...
                return new ExprEditor() {
                    public void edit(MethodCall m) throws CannotCompileException {
                        if (m.getMethodName().equals("renderFontLeftTopAligned")) {
                            m.replace(""
                                + "{"
                                    + "if (shopgrid.patches.ShopGridPatch.StorePotionPatches.Render.canRenderText($1, this))"
                                        + "com.megacrit.cardcrawl.helpers.FontHelper.renderFontLeftTopAligned($1, $2, $3, "
                                        + "shopgrid.patches.ShopGridPatch.StorePotionPatches.Render.textX(this, RELIC_PRICE_OFFSET_X), "
                                        + "shopgrid.patches.ShopGridPatch.StorePotionPatches.Render.textY(this, RELIC_PRICE_OFFSET_Y), $6);"
                                + "}"
                            );
                        }
                    }
