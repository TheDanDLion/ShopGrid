...
public class TextureLoader {
    ...
    public static Texture getTexture(final String textureString) {
        if (textures.get(textureString) == null) {
            try {
                ...
                /* --- changed by dandylion1740 --- */
                return getTexture(ShopGridInitializer.missingTexturePath);
                /* --- moving missing texture path to mod initialzier --- */
            }
        }
    ...
    private static void loadTexture(final String textureString) throws GdxRuntimeException {
        /* --- changed by dandylion1740 --- */
        logger.info(ShopGridInitializer.getModInfo().ID + " | Loading Texture: " + textureString);
        /* --- getting mod id instead of hard-coding */
